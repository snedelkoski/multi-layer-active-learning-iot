from datasets.dataset import load_reg
import time
from multiprocessing import Process
import numpy as np
from pathlib import Path
from code.random_sampling_reg import random_sampling_reg
...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        for nd, b, band in product(nr_devices, budget, bandwidth):
            import code.trainserver_reg as trainserver
            import code.edge_reg as edge
            ...
            p4 = Process(target=random_sampling_reg, args=(nr_exp, M))
            p4.start()
